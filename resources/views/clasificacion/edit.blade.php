...
<div class="container">
    ...
    <div class="row">
        <div class="col-x1-12">
            <form href="{{url('clasificacion.update',$clasificacion->id_clasificacion)}}" method="post">
                @csrf
                <div class="form-group">
                    <label for="id_clasificacion">ID_clasificacion</label>
                    <input type="text" class="form-control" name="id_cla" required maxlength="10" value={{"$clasificacion->id_clasificacion"}}>
                </div>
                <div class="form-group">
